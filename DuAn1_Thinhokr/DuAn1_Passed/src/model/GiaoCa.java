...
public class GiaoCa {
    ...
    public GiaoCa(String maGiaoCa, Date thoiGianNhanCa, Date thoiGianGiaoCa, String maNV, String maNvNhanCa, BigDecimal tenBanDau, BigDecimal tongTienTrongCa, BigDecimal tongTienMat, BigDecimal tongTienKhac, BigDecimal tienPhatSinh, String ghiChu, BigDecimal tongTienMatCaTruoc, Timer thoiGianReset, BigDecimal tongTienMatDaRut, Integer trangThai) {
    ...
    public Date getThoiGianNhanCa() {
        return thoiGianNhanCa;
    }

    public void setThoiGianNhanCa(Date thoiGianNhanCa) {
        this.thoiGianNhanCa = thoiGianNhanCa;
    }

    public Date getThoiGianGiaoCa() {
        return thoiGianGiaoCa;
    }

    public void setThoiGianGiaoCa(Date thoiGianGiaoCa) {
        this.thoiGianGiaoCa = thoiGianGiaoCa;
    }
